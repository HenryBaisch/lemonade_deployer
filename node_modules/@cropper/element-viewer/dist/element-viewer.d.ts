declare class CropperCanvas extends CropperElement_2_2 {
    static $name: string;
...
declare class CropperCanvas_2 extends CropperElement_2_3 {
    static $name: string;
    static $version: string;
    protected $onPointerDown: EventListener | null;
    protected $onPointerMove: EventListener | null;
...
declare class CropperImage extends CropperElement_2 {
    static $name: string;
    static $version: string;
...
declare class CropperSelection extends CropperElement_3 {
    static $name: string;
    static $version: string;
    protected $onCanvasAction: EventListener | null;
    protected $onCanvasActionStart: EventListener | null;
...
declare class CropperViewer extends CropperElement {
    static $name: string;
    static $version: string;
    ...
    protected $render(selection?: Selection_2): void;
    protected $transformImageByOffset(matrix: number[], x: number, y: number): void;
}
export default CropperViewer;

export declare const RESIZE_BOTH = "both";

export declare const RESIZE_HORIZONTAL = "horizontal";

export declare const RESIZE_NONE = "none";

export declare const RESIZE_VERTICAL = "vertical";
